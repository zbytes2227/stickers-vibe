  ...
  <div className="container px-5 py-12 mx-auto">
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
        <h2 className="text-sm title-font text-gray-500 tracking-widest">Dummy - Project-working-only</h2>
        <h2 className="text-sm title-font text-gray-500 tracking-widest">Stickers Vibe</h2>
        <h1 className="text-gray-900 text-3xl title-font font-medium mb-4">Order Id: #88455</h1>
        ...
        <h2 className="text-sm title-font text-gray-500 tracking-widest">Dummy -Just to show Project-working-only</h2>
        <div className="flex border-t border-gray-200 py-2">
          <span className="text-gray-500">Your Sticker</span>
      ...
      <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" src="/512.png"/>
    </div>
  </div>
</section>
  )
